...
class PollingStation:
    ...
    def tabulate_votes(self):
        ...
        # We will work on the surving candidates only and preserve the original
    ...
    def candidate_has_super_majority(self):
        # Raise a ValueError exception when no candidate has received any
        # ballots. Then return True if there is a candidate who has
        # super-majority
        pass
    ...
    def remove_last_and_reasign_votes(self):
        ...
        if (c_min.num_votes() == 0):
            # We've just removed that candidate; nothing to do
            return
